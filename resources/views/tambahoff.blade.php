                            ...
                            <form method="post" action="/tampil/storeoff"enctype="multipart/form-data">
                                {{ csrf_field() }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if($errors->has('judul_off'))
                                            <div class="text-danger">
                                                {{ $errors->first('judul_off')}}
                                            </div>
                                        @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="gambar_off">
                                         ...
                                         @if($errors->has('gambar_off'))
                                            <div class="text-danger">
                                                {{ $errors->first('gambar_off')}}
                                            </div>
                                        @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if($errors->has('harga_off'))
                                            <div class="text-danger">
                                                {{ $errors->first('harga_off')}}
                                            </div>
                                        @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="isi_off" class="form-control" placeholder="masukkan isi_off"></textarea> 
                                         ...
                                         @if($errors->has('isi_off'))
                                            <div class="text-danger">
                                                {{ $errors->first('isi_off')}}
                                            </div>
                                        @endif
