                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-5">
                        <div class="card" style="width: 18rem;">
                          <img src="{{url('assets/images/pg/'.$pg->gambar_pg)}}" class="card-img-top" alt="...">
                          <div class="card-body">
                            <h5 class="card-title">{{$pg->judul_pg}}</h5>
                            <h3 class="card-text">Rp <label class="uang"> {{$pg->harga_pg}}</label></h3>
                            <p class="card-text">
                          ...
                          <div class="card-footer">
                            ...
                            @else
                            <a href="#modal{{$pg->id}}" data-toggle="modal" class="btn btn-primary text-center">Detail produk</a>
                            @endif
                          </div>
...
<!-- Modal softwere1-->
@foreach($programming as $pg)
<div class="modal fade" id="modal{{$pg->id}}" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document" id="{{$pg->id}}">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">{{$pg->judul_pg}}</h5>
      ...
      <div class="modal-body">
        <h3>Rp. {{$pg->harga_pg}}</h3>
        
        <div class="modal-text">{{$pg->isi_pg}}<br></div>
