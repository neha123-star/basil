                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-5">
                        <div class="card" style="width: 18rem;">
                          <img src="{{url('assets/images/desain/'.$ds->gambar_ds)}}" class="card-img-top" alt="...">
                          <div class="card-body">
                            <h5 class="card-title">{{$ds->judul_ds}}</h5>
                            <h3 class="card-text">Rp <label class="uang"> {{$ds->harga_ds}}</label></h3>
                            <p class="card-text">
                          ...
                          <div class="card-footer">
                            ...
                            @else
                            <a href="#modal{{$ds->id}}" data-toggle="modal" class="btn btn-primary text-center">Detail produk</a>
                            @endif
                        </div>
                    </div>
                    @endforeach
...
<!-- Modal softwere1-->
@foreach($desain as $ds)
<div class="modal fade" id="modal{{$ds->id}}" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document" id="{{$ds->id}}">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">{{$ds->judul_ds}}</h5>
      ...
      <div class="modal-body">
        <h3>Rp. {{$ds->harga_ds}}</h3>
        <div class="modal-text">{{$ds->isi_ds}}<br></div>
