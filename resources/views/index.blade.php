...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
    ...
    <section class="ftco-section-2 img mb-5" style="background-image: url('{{url('assets/images/bg_3.jpg')}}');">
            ...
            <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="{{url('assets/images/9.png')}}" class="d-block w-100" alt="...">
                ...
                <div class="carousel-item">
                  <img src="{{url('assets/images/2.png')}}" class="d-block w-100" alt="...">
                  <div class="carousel-caption d-none d-md-block">
                    <div class="text-light">
                ...
                <div class="carousel-item">
                  <img src="{{url('assets/images/h.png')}}" class="d-block w-100" alt="...">
                  <div class="carousel-caption d-none d-md-block">
                    <div class="text-light">
