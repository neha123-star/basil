			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-6 text-right">
						<a href="/tampil/tambahds" ><h2 class="text-primary"><i class="fa fa-plus-circle" ></i></h2></a>
					</div>
				</div>
				<?php $__currentLoopData = $lihatds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ds): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<div class="row mb-4">
						<div class="col-md-4">
							<img src="<?php echo e(url('assets/images/desain/'.$ds->gambar_ds)); ?>" alt="..." class="img-thumbnail">
						</div>
						<div class="col-md-8">
							<div class="text">
								<h5><?php echo e($ds->judul_ds); ?></h5>
								<h5>Rp <label class="uang"> <?php echo e($ds->harga_ds); ?></label></h5>
								<p class="text-truncate"><?php echo e($ds->isi_ds); ?></p>
								<a href="/tampil/editds/<?php echo e($ds->id); ?>" class="btn btn-outline-dark">Edit</a>
								<a href="/tampil/hapusds/<?php echo e($ds->id); ?>" class="btn btn-outline-dark">Hapus</a>
							</div>
						</div>
				</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project\resources\views/lihatds.blade.php ENDPATH**/ ?>