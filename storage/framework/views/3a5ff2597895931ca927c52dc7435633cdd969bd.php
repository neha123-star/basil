                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-5">
                        <div class="card" style="width: 18rem;">
                          <img src="<?php echo e(url('assets/images/off/'.$off->gambar_off)); ?>" class="card-img-top" alt="...">
                          <div class="card-body">
                            <h5 class="card-title"><?php echo e($off->judul_off); ?></h5>
                            <h3 class="card-text">Rp <label class="uang"> <?php echo e($off->harga_off); ?></label></h3>
                            <p class="card-text">
                              <div class="text-truncate">
                              <?php echo e($off->isi_off); ?>
                        ...
                        <?php else: ?>
                            ...
                            <a href="#modal<?php echo e($off->id); ?>" data-toggle="modal" class="btn btn-primary">Detail produk</a>   
                           <?php endif; ?>
                          </div>
                        </div>
                    </div>
...
<!-- Modal softwere1-->
<?php $__currentLoopData = $office; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $off): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<div class="modal fade" id="modal<?php echo e($off->id); ?>" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document" id="<?php echo e($off->id); ?>">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle"><?php echo e($off->judul_off); ?></h5>
      ...
      <div class="modal-body">
        <h3>Rp. <?php echo e($off->harga_off); ?></h3>
        <div class="modal-text"><?php echo e($off->isi_off); ?><br></div>
...
</html><?php /**PATH C:\xampp\htdocs\project\resources\views/office.blade.php ENDPATH**/ ?>