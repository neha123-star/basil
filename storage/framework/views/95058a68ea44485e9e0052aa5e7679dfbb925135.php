                            ...
                            <form method="post" action="/tampil/storepg"enctype="multipart/form-data">
                                <?php echo e(csrf_field()); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php if($errors->has('judul_pg')): ?>
                                            <div class="text-danger">
                                                <?php echo e($errors->first('judul_pg')); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="gambar_pg" class="form-control" placeholder="masukkan gambar_pg">
             
                                         <?php if($errors->has('gambar_pg')): ?>
                                            <div class="text-danger">
                                                <?php echo e($errors->first('gambar_pg')); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php if($errors->has('harga_pg')): ?>
                                            <div class="text-danger">
                                                <?php echo e($errors->first('harga_pg')); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="isi_pg" class="form-control" placeholder="masukkan isi_pg"></textarea> 
                                         ...
                                         <?php if($errors->has('isi_pg')): ?>
                                            <div class="text-danger">
                                                <?php echo e($errors->first('isi_pg')); ?>
...
</html><?php /**PATH C:\xampp\htdocs\project\resources\views/tambahpg.blade.php ENDPATH**/ ?>