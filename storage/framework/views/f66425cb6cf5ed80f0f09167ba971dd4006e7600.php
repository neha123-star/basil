			...
			<div class="container ">
				...
				<div class="row ">
					...
					<div class="col-md-6 text-right">
						<a href="/tampil/tambahoff" ><h2 class="text-primary"><i class="fa fa-plus-circle" ></i></h2></a>
					</div>
				</div>
				<?php $__currentLoopData = $lihatoff; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $off): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<div class="row mb-4">
						<div class="col-md-4">
							<img src="<?php echo e(url('assets/images/off/'.$off->gambar_off)); ?>" alt="..." class="img-thumbnail">
						</div>
						<div class="col-md-8">
							<div class="text">
								<h5><?php echo e($off->judul_off); ?></h5>
								<h5>Rp <label class="uang"> <?php echo e($off->harga_off); ?></label></h5>
								<p class="text-truncate"><?php echo e($off->isi_off); ?></p>
								<a href="/tampil/edit/<?php echo e($off->id); ?>" class="btn btn-outline-dark">Edit</a>
								<a href="/tampil/hapus/<?php echo e($off->id); ?>" class="btn btn-outline-dark">Hapus</a>
							</div>
						</div>
				</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project\resources\views/lihatoff.blade.php ENDPATH**/ ?>