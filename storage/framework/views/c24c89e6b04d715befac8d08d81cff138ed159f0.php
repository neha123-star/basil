	  ...
	  <section id="home-section" class="hero">
      	...
      	<div class="one-third order-md-last img js-fullheight" style="background-image:url('<?php echo e(url('assets/images/bg_1.jpg')); ?>');">
		          ...
		          <div class="one-forth d-flex js-fullheight align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
			            <h1 class="mb-4 mt-3">Software Programming</h1>
			            <p>Semua kebutuhan software untuk programming ada di sini</p>
		            </div>
		          </div>
	        	</div>
	        </div>
      ...
      <section class="ftco-section ftco-project bg-white">
            <div class="container  px-md-5 text-dark">
                <div class="row justify-content-center pb-5">
                    <div class="col-md-12">
                        <div class="text">
                            <h5>Temukan berbagai jenis software Programming, hanya di sini</h5>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-4 mb-5">
                        <div class="card" style="width: 18rem;">
                          <img src="<?php echo e(url('assets/images/pg/'.$pg->gambar_pg)); ?>" class="card-img-top" alt="...">
                          <div class="card-body">
                            <h5 class="card-title"><?php echo e($pg->judul_pg); ?></h5>
                            <h3 class="card-text">Rp <label class="uang"> <?php echo e($pg->harga_pg); ?></label></h3>
                            <p class="card-text">
                              <div class="text-truncate">
                              <?php echo e($pg->isi_pg); ?>
                          ...
                          <div class="card-footer">
                             <?php if(Route::has('register')): ?>
                             <div class="text">
                               Login untuk mendapatkan info lebih lajut....
                             </div>
                                

                            <?php else: ?>
                            <a href="#modal<?php echo e($pg->id); ?>" data-toggle="modal" class="btn btn-primary text-center">Detail produk</a>
                            <?php endif; ?>
                          </div>
...
<!-- Modal softwere1-->
<?php $__currentLoopData = $programming; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<div class="modal fade" id="modal<?php echo e($pg->id); ?>" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document" id="<?php echo e($pg->id); ?>">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle"><?php echo e($pg->judul_pg); ?></h5>
      ...
      <div class="modal-body">
        <h3>Rp. <?php echo e($pg->harga_pg); ?></h3>
        
        <div class="modal-text"><?php echo e($pg->isi_pg); ?><br></div>
...
</html><?php /**PATH C:\xampp\htdocs\project\resources\views/programming.blade.php ENDPATH**/ ?>